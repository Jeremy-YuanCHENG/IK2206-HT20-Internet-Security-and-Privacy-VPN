...
public class ForwardServerClientThread extends Thread
{
     ...
     */
    public ForwardServerClientThread(ServerSocket listensocket, String serverhost, int serverport, byte[] key, byte[] iv, boolean tureOrFalse) throws IOException
    {
        mListenSocket = listensocket;
        mServerPort = serverport;
        mServerHost = serverhost;

        clientIn = tureOrFalse;
