...
public class ForwardServer
{
     ...
     */
    private void doHandshake(Socket handshakeSocket,String userCert, String caCert) throws UnknownHostException, IOException, Exception {

        serverHandshake = new ServerHandshake(handshakeSocket, userCert, caCert);
    }
            ...
            throws Exception
    {
        ...
        while(true) {
            ...
            doHandshake(handshakeSocket,arguments.get("usercert"),arguments.get("cacert"));
            ...
            forwardThread = new ForwardServerClientThread(serverHandshake.sessionSocket, serverHandshake.targetHost, serverHandshake.targetPort, serverHandshake.sessionKey, serverHandshake.sessionIV, false);
            forwardThread.start();
        }
    }
