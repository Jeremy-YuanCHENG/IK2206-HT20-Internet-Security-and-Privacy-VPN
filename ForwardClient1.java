...
public class ForwardClient
{
    ...
    private static void doHandshake(Socket handshakeSocket, String targethost, String targetport, String cacert,String usercert,String clientPrivateKeyFile) throws IOException, BadPaddingException, NoSuchAlgorithmException, IllegalBlockSizeException, CertificateException, NoSuchPaddingException, InvalidKeyException, InvalidKeySpecException {
     ...
     */
    static public void startForwardClient() throws IOException, InvalidKeyException, CertificateException, NoSuchAlgorithmException, InvalidKeySpecException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException {
        ...
        ForwardServerClientThread forwardThread =
                new ForwardServerClientThread(proxySocket, clientHandshake.sessionHost, clientHandshake.sessionPort, clientHandshake.getSessionKey(), clientHandshake.getSessionIV(), true);
        /*
         * Launch the fowarder
         */
        forwardThread.start();
